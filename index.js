...
const TASI_TOKEN = process.env.TASI_TOKEN || "<ضع توكن بوت تاسي هنا>";
const US_TOKEN = process.env.US_TOKEN || "<ضع توكن بوت US هنا>";
const EODHD_API_KEY = process.env.EODHD_API_KEY || "<ضع مفتاح EODHD هنا>";
